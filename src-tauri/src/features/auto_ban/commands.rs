...
#[tauri::command]
pub async fn set_auto_ban(state: tauri::State<'_, AppState>, enabled: bool) -> Result<(), String> {
...
#[tauri::command]
pub async fn get_auto_ban(state: tauri::State<'_, AppState>) -> Result<bool, String> {
